...
public class Loop implements Runnable {
    ...
    public void initialiseGame(GameSurface gameSurface){
        ...
        coordinator.registerComponentType(Component.getType(Render.class));

        Log.d("Loading", "Transform: " + Component.getType(Transform.class));
        Log.d("Loading", "PhysicsBody: " + Component.getType(PhysicsBody.class));
        Log.d("Loading", "Render: " + Component.getType(Render.class));

        renderSystem = new RenderSystem(coordinator, gameSurface);
        coordinator.registerSystem(renderSystem);
        Signature signature = new Signature();
        signature.set(Component.getType(Transform.class));
        signature.set(Component.getType(Render.class));
        ...
        coordinator.addComponent(entity, render);
        physicsBody = physicsSystem.createPhysicsBody(transform);
        coordinator.addComponent(entity, physicsBody);
    }
